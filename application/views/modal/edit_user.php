      ...
      <div class="modal-body">
          ...
          <div class="row">
              <div class="form-group m-0 col-sm-12">
                  ...
                  <input type="text" name="username" class="form-control" value="<?=!empty($user['username']) ? $user['username'] : ''?>" required <?=!empty($user['username'])  && $user['username'] == 'admin' ? 'readonly' : ''?>>
              </div>
              <div class="form-group m-0 col-sm-12 d-none">
